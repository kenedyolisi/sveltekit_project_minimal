<script lang="ts" module>
  ...
  export const sidebarMenuButtonVariants = tv({
    base: cn(
      ...
      "active:text-sidebar-accent-foreground data-active:bg-sidebar-accent",
      "data-active:text-sidebar-accent-foreground",
      "data-open:hover:bg-sidebar-accent",
      "data-open:hover:text-sidebar-accent-foreground gap-2 rounded-md p-2",
      "text-left text-sm transition-[width,height,padding]",
      "group-has-data-[sidebar=menu-action]/menu-item:pr-8",
      "group-data-[collapsible=icon]:size-8! group-data-[collapsible=icon]:p-2!",
      " focus-visible:ring-2 data-active:font-medium peer/menu-button",
      "group/menu-button flex w-full items-center overflow-hidden",
