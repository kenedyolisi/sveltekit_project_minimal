<script lang="ts" module>
  ...
  export const sidebarMenuButtonVariants = tv({
    base: [
      "peer/menu-button outline-hidden ring-sidebar-ring hover:bg-sidebar-accent",
      "hover:text-sidebar-accent-foreground active:bg-sidebar-accent",
      "active:text-sidebar-accent-foreground group-has-data-[sidebar=menu-action]/menu-item:pr-8",
