<script lang="ts">
  ...
  import SelectScrollDownButton from "./select_scroll_down_button.svelte";
  import SelectScrollUpButton from "./select_scroll_up_button.svelte";
...
<SelectPrimitive.Portal {...portalProps}>
  <SelectPrimitive.Content
    ...
    class={cn(
      ...
      "origin-(--bits-select-content-transform-origin) overflow-x-hidden overflow-y-auto",
